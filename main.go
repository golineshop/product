...
import (
	...
	service2 "github.com/golineshop/product/domain/service"
...
func main() {
	...
	// Register Handler
	proto.RegisterProductHandler(service.Server(), &handler.ProductController{ProductService: productService})
